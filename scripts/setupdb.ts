...
db.query(userTableQuery, (error) => {
    if (error) console.log("Error [" + error.code + "]: unable to create Users table");
    else console.log("Created Users table");
});

db.query(networkTableQuery, (error) => {
    if (error) console.log("Error [" + error.code + "]: unable to create Network table");
    else console.log("Created Network table");
});

db.query(channelTableQuery, (error) => {
    if (error) console.log("Error [" + error.code + "]: unable to create Channels table");
    else console.log("Created Channels table");
});

db.query(bondTableQuery, (error) => {
    if (error) console.log("Error [" + error.code + "]: unable to create bonds table");
    else console.log("Created bonds table");
});
